...
//       <>
//         <Dropdown.Item key={assignment._id} className="wd-assignment-list-item" style={{ whiteSpace: 'normal', padding: '10px 15px' }}>
...
export default function Assignments() {
  ...
  const assignments: Assignment[] = db.assignments.filter(a => a.course === cid);
