...
export default function ExamEditor() {
    return (
        <div id="wd-exams-editor">
            <label htmlFor="wd-name">Exam Name</label><br />
            <input id="wd-name" defaultValue="Midterm Exam" /><br /><br />
            <textarea id="wd-description">
                The exam will cover all material from weeks 1-6. 
                It will include multiple choice questions, short answer questions, and coding problems.
                Please review all lecture notes, assignments, and readings.
            </textarea>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select id="wd-group">
                            ...
                            <option value="3" selected>Exams</option>
